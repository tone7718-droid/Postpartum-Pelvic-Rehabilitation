...
널리 퍼진 얘기지만 **1차 연구로는 뒷받침되지 않습니다.** 혈중 릴랙신은 출산 후 빠르게 감소하며, 모유수유 때문에 오래 높게 유지된다는 근거는 없습니다. 다만 **관절의 느슨함 자체는 릴랙신과 무관하게 수개월(손가락 관절 ~13주) 남을 수 있으므로**, "첫 수개월은 무리한 고강도·깊은 스트레칭을 피한다"는 실천 원칙은 여전히 유효합니다. (자세히는 0장 참고)
...
> 🚨 아래는 "운동 관련" 신호입니다. **호흡 곤란·가슴 통증·실신·가라앉지 않는 심한 두통·다량 출혈·자신이나 아기를 해치고 싶은 생각** 등은 응급 증상이므로 즉시 응급 도움(119·응급실)을 받으세요([6장 6-2](06-practical-tools.md) 참고).
